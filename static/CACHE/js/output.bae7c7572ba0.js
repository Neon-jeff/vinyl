...
nav.style.visibility="hidden";let toggleVisible=function(elem){if(elem.style.visibility==="hidden"){elem.style.visibility="visible";}else{elem.style.visibility="hidden";}};window.addEventListener('load',()=>{console.log(window.location.pathname.split('/'));let pattern=new RegExp(window.location.pathname.replace('/',' '),'gi')
