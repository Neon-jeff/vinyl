...
for(let i=0;i<nav.children.length;i++){if(nav.children[i].textContent.match(pattern)){console.log(nav.children[i]);nav.children[i].style.backgroundColor="#c582f2";nav.children[i].style.padding="rpx";nav.children[i].style.borderRadius="10px";}}})
