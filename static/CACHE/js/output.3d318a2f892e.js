...
for(let i=0;i<nav.children.length;i++){if(nav.children[i].textContent.match(pattern)&&window.location.pathname!='/'){nav.children[i].style.backgroundColor="#c582f2";nav.children[i].style.padding="15px";nav.children[i].style.borderRadius="5px";}}})
